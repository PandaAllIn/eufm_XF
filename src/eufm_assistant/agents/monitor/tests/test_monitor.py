...
class TestMonitor(unittest.TestCase):
    def setUp(self):
        self.sample_wbs_data = {'work_packages': [{'id': 'WP1', 'title': 'Project Management', 'leader': 'Alice', 'tasks': [{'name': 'Task 1', 'end_date': '2099-12-31T00:00:00Z', 'status': 'In Progress'}]}, {'id': 'WP2', 'title': 'Research', 'leader': 'Bob', 'tasks': []}, {'id': 'WP3', 'title': 'Development', 'leader': None, 'tasks': [{'name': 'Task 2', 'end_date': '2023-01-01T00:00:00Z', 'status': 'Pending'}]}]}
