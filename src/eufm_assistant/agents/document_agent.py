...
class DocumentAgent:
    def __init__(self):
        ...
        # The knowledge base path is now relative to the new structure
        self.knowledge_base_path = "src/eufm_assistant/docs/Horizon_Xilella.md"

    def get_project_context(self):
        """
        Reads the project context from the Horizon_Xilella.md file.
        """
        try:
    ...
    def draft_outreach_emails(self, partner_data):
        """
        Drafts outreach emails to potential partners.
        """
