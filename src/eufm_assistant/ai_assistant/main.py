...
def main():
    ...
    parser.add_argument("--coordinator_task", default="wbs_status", help="The specific task for the coordinator agent (e.g., 'proposal_checklist').")
    ...
    if args.task == "find_partners":
        ...
        coordinator_agent.run(task=args.coordinator_task)
    else:
